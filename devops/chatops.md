...
- 처음부터 배포까지 열기보다 조회 명령부터 붙이는 게 안전함
- 누가 어떤 명령을 실행했는지 로그가 남아야 함
- 운영 명령은 권한과 승인 흐름을 같이 생각해야 함

### 누가 실행했는지 남기기

- 운영 명령은 실행자와 시간을 남겨야 나중에 추적 가능
- 위험한 명령은 확인 단계나 승인 흐름을 둠
- 조회 명령과 변경 명령의 권한을 나누는 편이 안전함
